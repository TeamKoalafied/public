...
class TestCharacteriseDriveBase : public frc2::CommandHelper<frc2::Command, TestCharacteriseDriveBase> {
public:
    //==========================================================================
    // Nested Types
    ...
    public:
        ...
        virtual frc2::CommandPtr CreateAutonomousCommand(SwerveDrivebase& drivebase, Manipulator& manipulator) override {
            return frc2::CommandPtr(std::unique_ptr<frc2::Command>(new TestCharacteriseDriveBase(&drivebase)));
        }
    };
