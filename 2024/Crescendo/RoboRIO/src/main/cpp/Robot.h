...
// only really has three responsibilities.
// 
//      - Creates the subsystems
//      - Create and schedule the autonomous command
//      - Create and update the main 'drive' shuffleboard tab
...
private:
    ...
    Manipulator* m_manipulator;             // Manipulator subsystem 0
    Leds* m_leds;                           // Leds subsystem
    DriveShuffleboard* m_drive_shuffleboard;// Shuffleboard display for overall robot control
