...
// the command runs.
class LogPathPlannerCommand : public frc2::CommandHelper<frc2::CommandBase, LogPathPlannerCommand> {
public:
    //==========================================================================
    // Public Nested Types
    ...
    LogPathPlannerCommand(SwerveDrivebase* drivebase, const pathplanner::PathPlannerTrajectory& trajectory, const Parameters parameters);
...
private:
    ...
    void LogTrajectory(Logging::CsvFile& csv_log_file, const pathplanner::PathPlannerTrajectory& trajectory);
