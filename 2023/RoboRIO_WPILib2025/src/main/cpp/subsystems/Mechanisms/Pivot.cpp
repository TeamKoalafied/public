...
void Pivot::Setup() {
	...
	pivot_configuration.WithCurrentLimits(ctre::phoenix6::configs::CurrentLimitsConfigs()
											...
											.WithSupplyCurrentLowerLimit(RC::kPivotMotorContinuousCurrentLimit)
											.WithSupplyCurrentLowerTime(RC::kPivotMotorPeakCurrentDurationMs));
	...
	pivot_configuration.WithHardwareLimitSwitch(ctre::phoenix6::configs::HardwareLimitSwitchConfigs()
												...
												.WithForwardLimitAutosetPositionValue(0.0_deg)
	...
	pivot_configuration.WithSoftwareLimitSwitch(ctre::phoenix6::configs::SoftwareLimitSwitchConfigs()
													...
													.WithReverseSoftLimitThreshold(motor_angle_limit_turns));
...
//	double motor_rps = (units::turns_per_second_t(velocity_degrees_per_second) / kPivotDegreesPerRev.value()).value();
	units::turns_per_second_t motor_tps = pivot_velocity * RC::kPivotGearRatio;
	...
	const units::second_t kPivotAccelerationTimeS = 0.25_s; // was 1.0
	units::turns_per_second_squared_t motor_tpsq = motor_tps/kPivotAccelerationTimeS; 

	// Set the parameters in the Talon
	m_pivot_speed_controller->GetConfigurator().Apply(ctre::phoenix6::configs::MotionMagicConfigs()
														.WithMotionMagicCruiseVelocity(motor_tps)
														.WithMotionMagicAcceleration(motor_tpsq));
}
