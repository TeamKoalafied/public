...
void Wrist::Setup() {
	...
	wrist_configuration.peakCurrentLimit = RC::kWristMotorPeakCurrentLimit.value();
	wrist_configuration.peakCurrentDuration = RC::kWristMotorPeakCurrentDurationMs.convert<units::millisecond>().value();
	wrist_configuration.continuousCurrentLimit = RC::kWristMotorContinuousCurrentLimit.value();
