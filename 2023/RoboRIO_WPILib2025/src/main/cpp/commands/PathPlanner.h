...
namespace PathPlanner {
    ...
    // Pose to use for path following
    enum class PoseSource
    {
        Odometry, // Use only the odometry pose
        Vision    // Use the vision pose, which fuses odometry and vision information
    };
    ...
    // Get the pose to use for path following
    PoseSource GetPoseSource();

    // Get the pose to use for path following
    void SetPoseSource(PoseSource pose_source);
}