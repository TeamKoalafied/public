...
//LogPathPlannerCommand::LogPathPlannerCommand(SwerveDrivebase* drivebase, pathplanner::PathPlannerTrajectory& trajectory,
LogPathPlannerCommand::LogPathPlannerCommand(SwerveDrivebase* drivebase,
...
// void LogPathPlannerCommand::LogTrajectory(Logging::CsvFile& csv_log_file, PathPlannerTrajectory& trajectory) {
...
//         csv_log_file << point.position.X().value() << point.position.Y().value();
...
//         csv_log_file << point.heading.Degrees().value() << distance.value() << point.velocity.value();
