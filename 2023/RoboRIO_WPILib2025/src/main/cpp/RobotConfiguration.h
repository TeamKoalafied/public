...
const units::meter_t kDriveBaseBumperWidth = 33.5_in;
const units::meter_t kDriveBaseBumperLength = 37.5_in;
...
// demos.
const double kDefaultDrivebaseSlowDownFactor = 0.3;
...
const units::ampere_t kDriveMotorContinuousCurrentLimitA = 20_A;

// Peak current limit for drive base motors in amps
const units::ampere_t kDriveMotorPeakCurrentLimitA = 30_A;

// Peak current duration for drive base motors in milliseconds  
const units::second_t kDriveMotorPeakCurrentDurationMs = 500_ms;

// Drive motor ramp rate in second from neutral to full
//const double kDriveMotorRampRateS = 0.8;
const units::second_t kDriveMotorRampRateS = 0.4_s;
...
const frc::Transform3d kRobotToCam =
                    frc::Transform3d(frc::Translation3d(-1.894_in, 6.866_in, 14.575_in),
...
const units::ampere_t kIntakeMotorPeakCurrentLimit = 25_A;

// Continuous current limit for the intake motor in amps
const units::ampere_t kIntakeMotorContinuousCurrentLimit = 18_A;

// Peak current limit duration for the intake motor in milliseconds
const units::second_t kIntakeMotorPeakCurrentDurationMs = 500_ms;

// Peak current limit for the winch motor in amps
const units::ampere_t kWinchMotorPeakCurrentLimit = 10_A;

// Continuous current limit for the winch motor in amps
const units::ampere_t kWinchMotorContinuousCurrentLimit = 8_A;

// Peak current limit duration for the winch motor in milliseconds
const units::second_t kWinchMotorPeakCurrentDurationMs = 500_ms;
...
const units::ampere_t kArmMotorPeakCurrentLimit = 20_A;

// Continuous current limit for the arm motor in amps
const units::ampere_t kArmMotorContinuousCurrentLimit = 15_A;

// Peak current limit duration for the arm motor in milliseconds
const units::second_t kArmMotorPeakCurrentDurationMs = 500_ms;

// Open loop ramp rate is long to give the operator control of the arm
const units::second_t kArmMotorOpenLoopRampRateS = 0.5_s;

// Close loop ramp rate is short so the PID operates properly
const units::second_t kArmMotorClosedLoopRampRateS = 0.05_s;
...
// Pivot current limts
const units::ampere_t kPivotMotorPeakCurrentLimit = 15_A;
const units::ampere_t kPivotMotorContinuousCurrentLimit = 10_A;
const units::second_t kPivotMotorPeakCurrentDurationMs = 500_ms;

// Open loop ramp rate is long to give the operator control of the pivot
const units::second_t kPivotMotorOpenLoopRampRateS = 0.8_s;

// Close loop ramp rate is short so the PID operates properly
const units::second_t kPivotMotorClosedLoopRampRateS = 0.05_s;
...
const units::ampere_t kWristMotorPeakCurrentLimit = 3_A;

// Continuous current limit for the wrist motor in amps
const units::ampere_t kWristMotorContinuousCurrentLimit = 2_A;

// Peak current limit duration for the wrist motor in milliseconds
const units::second_t kWristMotorPeakCurrentDurationMs = 500_ms;
