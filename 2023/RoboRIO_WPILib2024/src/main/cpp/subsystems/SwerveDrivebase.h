...
private:
    ...
    PeriodicTimer m_joystick_timer { "Joystick",
        (PeriodicTimer::Mode)(PeriodicTimer::AutoMilliseconds | PeriodicTimer::ShowProcessingWarnings),
        5000, false };
    PeriodicTimer m_simulation_timer { "Simulation",
        (PeriodicTimer::Mode)(PeriodicTimer::AutoMilliseconds | PeriodicTimer::ShowProcessingWarnings),
        5000, false };
    PeriodicTimer m_periodic_timer { "Periodic",
        (PeriodicTimer::Mode)(PeriodicTimer::AutoMilliseconds | PeriodicTimer::ShowProcessingWarnings),
        5000, false };
