...
public:
    ...
    //
    // Returns whether the shooter is at the required speed, within an appropriate tolerance for the PID loop
    bool DriveShooterClosedLoop(double shooter_wheel_rpm);

    // Get the current speed of the shooter wheel shaft in rpm. Positive is shooting.
    int GetShooterRPM();
