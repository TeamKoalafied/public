...
public:
    ...
    //
    // index_percentage_output - Percentage output to drive the lower part of the indexer at. Positive pulls the balls inwards.
    // kicker_percentage_output - Percentage output to drive the upper kicker part of the indexer at. Positive moves the balls upwards.
    void ManualDriveIndexer(double index_percentage_output, double kicker_percentage_output);
...
private:
    ...
    TalonSRX* m_kicker_speed_controller;   // Motor controller for the indexer
};
