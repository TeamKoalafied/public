...
//const int kShooterSlaveTalonId  = 3;
const int kIntakeTalonId = 4;
const int kIndexerTalonId = 3;
const int kKickerTalonId = 2;
const int kTurretTalonId = 12;
const int kHoodTalonId = 11;
const int kShooterMasterTalonId  = 13;
...
const int kPneumaticsIntakeSolenoidId = 0;
...
// Default value for overall slow down factor. Should always be 1.0 during the season.
const double kDefaultDrivebaseSlowDownFactor = 0.5;
...
const int kIntakeMotorPeakCurrentLimit = 35;

// Continuous current limit for the intake motor in amps
const int kIntakeMotorContinuousCurrentLimit = 25;
