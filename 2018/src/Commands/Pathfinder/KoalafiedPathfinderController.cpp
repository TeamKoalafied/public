...
KoalafiedPathfinderController::KoalafiedPathfinderController(Segment* left_trajectory, Segment * right_trajectory, int trajectory_length, const char* name) :
	PathfinderController(left_trajectory, right_trajectory, trajectory_length, name) {
}
