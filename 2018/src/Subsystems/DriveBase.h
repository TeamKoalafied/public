...
#include <Relay.h>
#include <Commands/DriveRotatePID.h>
...
private:
    ...
    DrivePath* m_forward_command;
    DriveStraight* m_backward_command;
    DriveRotate* m_left_command;
    DriveRotate* m_right_command;
    DriveRotate* m_180_command;

    DriveRotatePID* m_rotate_pid_command;
